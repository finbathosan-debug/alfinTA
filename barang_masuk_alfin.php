...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id_produk && $jumlah > 0) {
        // Tambah stok produk
        $query = mysqli_prepare($koneksiAlfin, "UPDATE produk_alfin SET stok_alfin = stok_alfin + ? WHERE id_produk_alfin = ?");
        mysqli_stmt_bind_param($query, 'ii', $jumlah, $id_produk);
        mysqli_stmt_execute($query);
        mysqli_stmt_close($query);
        // Catat riwayat barang masuk
        $query2 = mysqli_prepare($koneksiAlfin, "INSERT INTO barang_masuk_alfin (id_produk_alfin, jumlah_masuk, tanggal_masuk, keterangan) VALUES (?, ?, NOW(), ?)");
        mysqli_stmt_bind_param($query2, 'iis', $id_produk, $jumlah, $keterangan);
        mysqli_stmt_execute($query2);
        mysqli_stmt_close($query2);
        header("Location: barang_masuk_alfin.php?success=1");
        exit;
    }
}
...
<head>
    ...
    <title>Barang Masuk - alfinTA</title>
...
<div class="bm-page">
    <div class="bm-card">
        ...
        <div class="bm-header">
            ...
            <h2>Barang Masuk</h2>
            <p>Tambah stok produk ke dalam inventaris</p>
        </div>
        ...
        <div class="bm-body">
            ...
            <form method="POST" id="formBarangMasuk">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="jumlah" min="1" required
                           class="form-input" placeholder="Masukkan jumlah barang masuk" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="keterangan"
                           class="form-input" placeholder="Opsional — contoh: Restock dari supplier" />
                </div>
            ...
            <a href="dashboard_alfin.php" class="bm-back">← Kembali ke Dashboard</a>
    ...
    if (filtered.length === 0) {
        ...
        filtered.forEach((p, idx) => {
            ...
            item.innerHTML = `
                ...
                <span class="item-stock">Stok: ${parseInt(p.stok_alfin).toLocaleString('id-ID')}</span>
            `;
